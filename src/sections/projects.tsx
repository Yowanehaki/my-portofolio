                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex gap-1">
                    {project.technologies?.slice(0, 3).map((tech, index) => (
                      <span 
                        key={index} 
                        className="inline-block h-5 w-5 text-indigo-600 dark:text-indigo-400" 
                        title={tech}
                      >
                        {renderTechIcon(tech)}
                      </span>
                    ...
                    {project.technologies?.length > 3 && (
                      <span className="text-xs text-gray-500 dark:text-gray-400 self-center">+{project.technologies.length - 3}</span>
                    )}
                  </div>
                </div>
...
function renderTechIcon(tech) {
  // You can replace these with actual SVG icons for each technology
  const techIcons = {
    "React": (
    ...
    "Vue": (
      <svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M24 1.61h-9.94L12 5.16 9.94 1.61H0l12 20.78zm-18.77 3h3.22L12 14.08l3.55-9.47h3.22L12 21.16z"/>
      </svg>
    ),
    "Node": (
      <svg viewBox="0 0 24 24" fill="currentColor">
